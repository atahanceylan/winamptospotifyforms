...
namespace winamptospotifyforms
{
    public class CustomWebBrowser : WebBrowser
    {
        ...
        CustomWebBrowserEventHelper helper;
        ...
        protected override void CreateSink()
        {
            ...
            helper = new CustomWebBrowserEventHelper(this);
            cookie = new AxHost.ConnectionPointCookie(
                this.ActiveXInstance, helper, typeof(IDWebBrowserEvents2));
        }
        ...
        private class CustomWebBrowserEventHelper :
            StandardOleMarshalObject, IDWebBrowserEvents2
        {
            private CustomWebBrowser parent;            

            public CustomWebBrowserEventHelper(CustomWebBrowser parent)
            {
                this.parent = parent;
            }
